    ...
    >
      ...
      <div className="relative z-10 container mx-auto px-6">
        <motion.div
          ...
          className="relative bg-white/5 dark:bg-black/20 backdrop-blur-md border border-white/10 
                     rounded-2xl shadow-[0_10px_40px_-10px_rgba(0,0,0,0.3)] 
                     p-10 md:p-12 lg:p-14 transition-all duration-500
                     hover:border-primary/30 hover:shadow-[0_10px_50px_-10px_rgba(0,0,0,0.35)]"
        >
          <div className="relative grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
            ...
            >
              <h2 className="text-3xl md:text-4xl font-bold text-foreground leading-tight max-w-md">
            ...
            >
              ...
              >
                ...
                <Mail
                  className="w-5 h-5 text-[#020C28] group-hover:text-white group-hover:translate-x-1 transition-transform duration-300"
                />
              </motion.a>
            </motion.div>
          </div>
